...
3. **Recover hired agents.** For any team member they clearly set up (Darla, Chloe, Ella, Poppy, Treena, Lia, Sloane, Rhonda, Olivia, Brooke), reconstruct the same way — plain prose, opening with "<Name> is…" — show it, and on confirmation call `save_team_member`.
